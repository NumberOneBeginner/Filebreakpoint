...
import com.example.peter.chd.R;
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if(progressBar.getProgress()==progressBar.getMax()){
                        Toast.makeText(Main2Activity.this, R.string.success, 1).show();
                    }
                    break;
                case -1:
                    Toast.makeText(Main2Activity.this, R.string.error, 1).show();
                    break;
            }
        }
    };
...
//            public void onClick(View v) {
                ...
                if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
                    ...
                    Toast.makeText(Main2Activity.this, R.string.sdcarderror, 1).show();
                }
//            }
//        });
    }
    ...
    private void download(final String path, final File savedir) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                FileDownloader loader = new FileDownloader(Main2Activity.this, path, savedir, 3);
